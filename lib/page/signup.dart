          ...
          body: Container(
              ...
              child: ListView(
                children: [
                  ...
                  Text('well send your order confimation here',
                  ...
                  Text('Must be 10 or more characters',
                      style: TextStyle(color: Colors.grey)),
                  SizedBox(
                    height: 8.h,
                  ),
                  ...
                  Text('You need to be 16 or over to use Ebuy',
                      style: TextStyle(color: Colors.grey)),
                  SizedBox(
                    height: 8.h,
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'By creating your account,you ahree to our',
            style: TextStyle(color: Colors.grey, fontSize: 15),
            textAlign: TextAlign.left,
          ),
          SizedBox(
          ...
          Text(
            'Tems and Condition & Privacy Policy',
            style: TextStyle(
